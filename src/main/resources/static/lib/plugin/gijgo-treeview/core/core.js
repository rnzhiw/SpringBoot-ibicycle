...
gj.core.messages['bg-bg'] = {
    monthNames: ['携薪褍邪褉懈', '肖械胁褉褍邪褉懈', '袦邪褉褌', '袗锌褉懈谢', '袦邪泄', '挟薪懈', '挟谢懈', '袗胁谐褍褋褌', '小械锌褌械屑胁褉懈', '袨泻褌芯屑胁褉懈', '袧芯械屑胁褉懈', '袛械泻械屑胁褉懈'],
    monthShortNames: ['携薪褍', '肖械胁', '袦邪褉', '袗锌褉', '袦邪泄', '挟薪懈', '挟谢懈', '袗胁谐', '小械锌', '袨袣褌', '袧芯械', '袛械泻'],
    weekDaysMin: ['袧', '袩', '袙', '小', '效', '袩', '小'],
    weekDaysShort: ['袧械写', '袩芯薪', '袙褌芯', '小褉褟', '效械褌', '袩械褌', '小褗斜'],
    weekDays: ['袧械写械谢褟', '袩芯薪械写械谢薪懈泻', '袙褌芯褉薪懈泻', '小褉褟写邪', '效械褌胁褗褉褌褗泻', '袩械褌褗泻', '小褗斜芯褌邪'],
    am: 'AM',
    pm: 'PM',
    ok: '袨袣',
    cancel: '袨褌泻邪蟹'
...
gj.core.messages['fr-fr'] = {
    monthNames: ['janvier', 'f茅vrier', 'mars', 'avril', 'mai', 'juin', 'juillet', 'ao没t', 'septembre', 'octobre', 'novembre', 'd茅cembre'],
    monthShortNames: ['janv.', 'f茅vr.', 'mars', 'avr.', 'mai', 'juin', 'juil.', 'ao没t', 'sept.', 'oct.', 'nov.', 'd茅c.'],
...
gj.core.messages['de-de'] = {
    monthNames: ['Januar', 'Februar', 'M盲rz', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'],
    monthShortNames: ['Jan', 'Feb', 'M盲r', 'Apr', 'Mai', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez'],
...
gj.core.messages['pt-br'] = {
    monthNames: ['Janeiro', 'Fevereiro', 'Mar莽o', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],
    monthShortNames: ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez'],
    weekDaysMin: ['D', 'S', 'T', 'Q', 'Q', 'S', 'S'],
    weekDaysShort: ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'S谩b'],
    weekDays: ['Domingo', 'Segunda-feira', 'Ter莽a-feira', 'Quarta-feira', 'Quinta-feira', 'Sexta-feira', 'S谩bado'],
    am: 'AM',
    pm: 'PM',
    ok: 'OK',
    cancel: 'Cancelar'
...
gj.core.messages['ru-ru'] = {
    monthNames: ['携薪胁邪褉褜', '肖械胁褉邪谢褜', '袦邪褉褌', '袗锌褉械谢褜', '袦邪泄', '袠褞薪褜', '袠褞谢褜', '袗胁谐褍褋褌', '小械薪褌褟斜褉褜', '袨泻褌褟斜褉褜', '袧芯褟斜褉褜', '袛械泻邪斜褉褜'],
    monthShortNames: ['携薪胁', '肖械胁', '袦邪褉', '袗锌褉', '袦邪泄', '袠褞薪', '袠褞谢', '袗胁谐', '小械薪', '袨泻褌', '袧芯褟', '袛械泻'],
    weekDaysMin: ['袙褋', '袩薪', '袙褌', '小褉', '效褌', '袩褌', '小斜'],
    weekDaysShort: ['胁褋泻', '锌薪写', '胁褌褉', '褋褉写', '褔褌胁', '锌褌薪', '褋斜褌'],
    weekDays: ['胁芯褋泻褉械褋械薪褜械', '锌芯薪械写械谢褜薪懈泻', '胁褌芯褉薪懈泻', '褋褉械写邪', '褔械褌胁械褉谐', '锌褟褌薪懈褑邪', '褋褍斜斜芯褌邪'],
    am: 'AM',
    pm: 'PM',
    ok: '袨袣',
    cancel: '袨褌屑械薪邪'
...
gj.core.messages['es-es'] = {
    ...
    weekDaysMin: ['D', 'L', 'M', 'M', 'J', 'V', 'S'],
    weekDaysShort: ['dom', 'lun', 'mar', 'mi茅', 'jue', 'vie', 's谩b'],
...
gj.core.messages['tr-tr'] = {
    monthNames: ['ocak', '艧ubat', 'mart', 'nisan', 'may谋s', 'haziran', 'temmuz', 'a臒ustos', 'eyl眉l', 'ekim', 'kas谋m', 'aral谋k'],
    monthShortNames: ['oca', '艧ub', 'mar', 'nis', 'may', 'haz', 'tem', 'a臒u', 'eyl', 'eki', 'kas', 'ara'],
    weekDaysMin: ['P', 'S', '脟', 'P', 'C', 'C', 'P'],
    weekDaysShort: ['pzt.', 'sl.', '莽ar.', 'per.', 'cum.', 'cmt.', 'paz.'],
    weekDays: ['pazartesi', 'sal谋', '莽ar艧amba', 'per艧embe', 'cuma', 'cumartesi', 'pazar'],
    am: 'AM',
    pm: 'PM',
    ok: 'Tamam',
    cancel: '陌ptal'
